...
namespace Exercicio04
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=================================================================");
            Console.WriteLine("+ Escreva um programa que exiba na tela a quantidade de números +");
            Console.WriteLine("+ ímpares existentes entre dois números que o usuário digitar   +");
            Console.WriteLine("+ (testar inclusive os números digitados).                      +");
            Console.WriteLine("=================================================================");
            ...
            Console.WriteLine("A quantidade de numeros ímpares entre "+ n1+" e "+ n2+" é: "+ qtd);
