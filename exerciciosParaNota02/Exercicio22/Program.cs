...
namespace Exercicio22
{
    class Program
    {
        ...
        {
            double res = 0, l;
            Console.Title = "Soma dos 100 primeiros termos sequenciais";

            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("===============================================");
            Console.WriteLine("|  Soma dos 100 primeiros termos sequenciais  |");
            Console.WriteLine("===============================================");
            ...
            Console.WriteLine("A soma dos 100 primeiros termos é: "+ (res));
            Console.ReadKey();
