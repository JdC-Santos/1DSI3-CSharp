...
namespace Exercicio23
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double res = 1, l;
            Console.Title = "*Soma dos 80 primeiros termos sequenciais*";

            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("===============================================");
            Console.WriteLine("|  Soma dos 80  primeiros termos sequenciais  |");
            Console.WriteLine("===============================================");
            ...
            Console.WriteLine("A soma dos 80 primeiros termos é: " + (res));
            Console.ReadKey();
